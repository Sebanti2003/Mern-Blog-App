  ...
  return (
    <div className="w-screen h-screen dark:bg-slate-800 flex justify-center items-center flex-col lg:flex-row font-serif max-lg:pt-16 gap-5 p-2">
      ...
      <form onSubmit={postbody} className="w-[30%]  max-lg:w-[80%] h-[60%]  flex flex-col justify-center items-center p-2 gap-5">
        ...
        <button disabled={loading} type="submit" className="text-white dark:text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">{loading?<p>Loading...</p>:<p>Register Now</p>}</button>
